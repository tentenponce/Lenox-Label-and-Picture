...
public class MyActivity extends PreferenceActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tensize.setValue(String.valueOf(android.provider.Settings.System.getInt(getContentResolver(), "tensize", 0)));
        tensize.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            @Override
            public boolean onPreferenceChange(Preference preference, Object o) {
                android.provider.Settings.System.putInt(getContentResolver(), "tensize", Integer.valueOf((String)o).intValue());
                return true;
            }
        });

        tenstyle = (ListPreference) prefSet.findPreference("tenstyle");
        tenstyle.setValue(String.valueOf(android.provider.Settings.System.getInt(getContentResolver(), "tenstyle", 3)));
        tenstyle.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            @Override
            public boolean onPreferenceChange(Preference preference, Object o) {
                android.provider.Settings.System.putInt(getContentResolver(), "tenstyle", Integer.valueOf((String)o).intValue());
                return true;
            }
        });
    ...
    private int getLabelColor() {
        try {
            ...
            return getResources().getInteger(com.android.internal.R.color.white);
        }
    }
